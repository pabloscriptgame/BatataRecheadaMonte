...
const menuItems = [
    ...
    { name: "Galinhada Morena", img: "https://iili.io/fkM2WvV.png", desc: "Tutu te feijao + Salada de tomate + Repolho e Pimentão + Salada vai separadamente ", sizes: [{ size: "500ml", price: 20.00 }] },
